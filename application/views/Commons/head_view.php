<head>
  ...
  <!-- Icono -->
  <link rel="icon" type="img/icon" href="<?= base_url('vendor') ?>/dist/img/logos/favicon.ico">
  ...
  <!-- Own stylesheets -->
  <!-- <link rel="stylesheet" href="<?= base_url('vendor') ?>/dist/css/personalized.css"> -->

  <link rel="stylesheet" href="<?= base_url('vendor') ?>/dist/css/beaver.css">
